...
An `anyOf` condition will return as soon as one of the conditions nested within it returns true. Any conditions listed after that will not be executed.
`script` conditions will evaluate to "true" if they return any value other than `null`.
